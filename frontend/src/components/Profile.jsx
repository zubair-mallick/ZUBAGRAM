...
const Profile = () => {
  ...
  return (
    ...
    <div className="relative z-10 flex flex-col items-center w-full max-w-4xl mt-[2vh] p-6 bg-zinc-300 bg-opacity-80 rounded-md shadow-lg">
      ...
      <div
        className="header flex flex-col md:flex-row w-full justify-between items-center py-1 md:py-6 md:px-4 mb-2 md:mb-4 bg-gradient-to-r from-red-600 via-red-500 to-red-400 rounded-md"
        style={{
      ...
      >
        <div className="flex flex-col items-center md:flex-row ">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            <h1 className="text-xl md:text-2xl font-bold text-zinc-100 bg-red-800 my-1 px-3 uppercase rounded-full">{userProfile?.username}</h1>
